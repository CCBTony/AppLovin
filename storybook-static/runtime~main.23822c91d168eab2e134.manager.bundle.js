(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      ...
      '.' +
      {
        256: '43161e1df242389d0a22',
        295: 'bdadb8d0a0872e499f24',
        515: '3032865ee39823784c91',
        528: 'd8f7299b6e562fb67de8',
        551: '60fedea3aa0e3edfab9b',
        675: '3ba954d93bd4ed2ad7f8',
        974: '3ec7f79999597ac3b01d',
      }[chunkId] +
      '.manager.bundle.js'),
      ...
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (var scripts = document.getElementsByTagName('script'), i = 0; i < scripts.length; i++) {
            var s = scripts[i];
            if (s.getAttribute('src') == url || s.getAttribute('data-webpack') == 'app-lovin:' + key) {
              script = s;
              break;
            }
          }
        script ||
          ...
          script.setAttribute('data-webpack', 'app-lovin:' + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkapp_lovin = self.webpackChunkapp_lovin || []);
